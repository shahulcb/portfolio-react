          ...
          <Col colFor="type2">
            <Link to={"/blogs/1"}>
              <Card
                ...
                imageSrc={
                  "https://framerusercontent.com/images/ukUaYu6JmoCFF4mRt1nFlb0I.jpg?scale-down-to=512"
                }
              />
            </Link>
          </Col>
          <Col colFor="type2">
            <Link to={"/blogs/1"}>
              <Card
                ...
                imageSrc={
                  "https://framerusercontent.com/images/0v7xoTuiARlYIBsk2AHJAZFmXTI.jpg?scale-down-to=512"
                }
              />
            </Link>
          </Col>
